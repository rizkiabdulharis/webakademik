...
<button type="button" onclick=window.location.href='./media.php?page=form-jadwal'>Tambah Data Jadwal</button> <br><br>
...
<table width="100%" border="1" cellpadding="4" cellspacing="0">
    ...
    ?>
        <tr>
            ...
            <td align='center'> <?php echo $row['kd_jadwal']; ?> </td>
            ...
            <td align='center'>
                <a href="media.php?page=editjadwal&kd_jadwal=<?php echo $row['kd_jadwal']; ?>">Edit</a> |
                <a href="media.php?page=hapusjadwal&kd_jadwal=<?php echo $row['kd_jadwal']; ?>">Hapus</a>
            </td>
        </tr>
    <?php
        $no++;
