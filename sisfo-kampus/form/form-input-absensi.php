...
if (isset($_POST['update'])) {
   $update = mysqli_query($conn,"UPDATE tbl_krs_mhs set absensi='$_POST[nilai]' WHERE id_krs='$_POST[id_krs]'");

   if ($update) { ?>
      <script>
         window.location.href = "./media.php?page=form-input-absensi&kd_jadwal=<?php echo $_GET['kd_jadwal'] ?>"
      </script>
<?php
   }
}
